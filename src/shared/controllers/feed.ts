import {JsonController, Get, Param, QueryParam, QueryParams, OnUndefined,
  ForbiddenError, InternalServerError, BadRequestError, Req} from 'routing-controllers';
...
export class FeedController {
  ...
  @OpenAPI({
    ...
    description: 'A single feed and its descendant timeseries will be returned.',
    responses: {
      200: {
    ...
    parameters: [
      {
        in: 'path',
        name: 'id',
        description: 'Feed ID to retrieve description and associated set of timeseries for.',
        required: true,
        type: 'string',
        format: 'uuid'
      },
  ...
  @OpenAPI({
    ...
    description: 'A single feed and its descendant timeseries will be returned if one can be matched successfully. If developing code, we recommend using the UUID form for accessing feeds as this alleviates name changes.',
    responses: {
      200: {
        description: 'Successful request',
        schema: {
    ...
    parameters: [
      ...
      },
      {
        in: 'path',
        name: 'metric',
        description: 'Metric to retrieve description and associated set of timeseries for.',
        required: true,
        type: 'string'
      },
      ...sharedQueryParams
