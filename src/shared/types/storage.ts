...
export class Storage extends StorageBase {
  ...
  public static async assert(u: StorageProperties, trx?: Transaction, instance?: Storage): Promise<any> {
  ...
  public static async create(u: UnitProperties, trx?: Transaction): Promise<any> {
  ...
  public static async getById(storageId: number, trx?: Transaction): Promise<Storage> {
    return await this.namedQuery(`Get storage with the ID '${storageId}'`, trx)
      .findOne({storage_id: storageId});
  }

  public static async getByName(name: string, trx?: Transaction): Promise<Storage> {
    return await this.namedQuery(`Get storage from name '${name}'`, trx)
      .findOne({name: name});
  }
