...
DROP INDEX IF EXISTS "IDX: ${TABLE_PREFIX}technology::organisation" CASCADE;
...
SELECT create_hypertable('${TABLE_PREFIX}data_json', 'time', chunk_time_interval => interval '1 day');
...
SELECT create_hypertable('${TABLE_PREFIX}data_bool', 'time', chunk_time_interval => interval '1 day');
...
SELECT create_hypertable('${TABLE_PREFIX}data_int', 'time', chunk_time_interval => interval '1 day');
...
SELECT create_hypertable('${TABLE_PREFIX}data_real', 'time', chunk_time_interval => interval '1 day');
...
SELECT create_hypertable('${TABLE_PREFIX}data_string', 'time', chunk_time_interval => interval '1 day');
...
SELECT create_hypertable('${TABLE_PREFIX}data_ts', 'time', chunk_time_interval => interval '1 day');
...
SELECT create_hypertable('${TABLE_PREFIX}data_event', 'time', chunk_time_interval => interval '1 day');
...
SELECT create_hypertable('${TABLE_PREFIX}data_file', 'time', chunk_time_interval => interval '1 day');
