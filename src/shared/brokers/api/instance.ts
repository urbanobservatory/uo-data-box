...
export class APIInstance extends Datapoint {
  ...
  private unixTime: String = '1970-01-01T00:00:00.000Z'
  ...
  public getDataEntry() {
    ...
    // NOTE: this should never happen when broker is configured correctly
    if (!entryMetadata || !this.options.identifier) return null
  ...
  public consumeStatic(instanceData: any, responseData?: any) {
